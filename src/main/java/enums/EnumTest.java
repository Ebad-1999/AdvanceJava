...
public class EnumTest {
    ...
    private static void benefitsOfEnumOverConstant(){
        ...
        System.out.println("Transaction Code for Deposit: "+ TransactionType.TRANSFER.getTransactioCode());//to get value
        System.out.println("Transaction Ordinal for Deposit: "+ TransactionType.TRANSFER.ordinal());//to get ordinal or index
        System.out.println("Transaction Name for Deposit: "+ TransactionType.TRANSFER.name());//to get name of const
    }
